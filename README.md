...
| ツール名                 | 説明                 | パラメータ       |
| ------------------------ | -------------------- | ---------------- |
| `trocco_get_users`       | ユーザー一覧を取得   | `limit`          |
...
| ツール名                 | 説明               | パラメータ       |
| ------------------------ | ------------------ | ---------------- |
| `trocco_get_teams`       | チーム一覧を取得   | `limit`          |
...
| ツール名                           | 説明                         | パラメータ                 |
| ---------------------------------- | ---------------------------- | -------------------------- |
| `trocco_get_resource_groups`       | リソースグループ一覧を取得   | `limit`                    |
...
| ツール名                  | 説明               | パラメータ                                                                                                 |
| ------------------------- | ------------------ | ---------------------------------------------------------------------------------------------------------- |
| `trocco_get_labels`       | ラベル一覧を取得   | `limit`, `job_definition_id`, `job_definition_bulk_id`, `datamart_definition_id`, `pipeline_definition_id` |
...
| ツール名                   | 説明             | パラメータ                          |
| -------------------------- | ---------------- | ----------------------------------- |
| `trocco_get_notifications` | 通知先一覧を取得 | `notification_type` (必須), `limit` |

### 接続情報

| ツール名                                     | 説明                 | パラメータ                                       |
| -------------------------------------------- | -------------------- | ------------------------------------------------ |
| `trocco_get_connection_configurations`       | 接続情報一覧を取得   | `connection_type` (必須), `limit`                |
...
| `trocco_get_jobs`                  | 特定のジョブ定義のジョブ一覧を取得 | `job_definition_id` (必須), `limit`, `start_time`, `end_time`, `time_zone` |
...
| ツール名                                | 説明                         | パラメータ                      |
| --------------------------------------- | ---------------------------- | ------------------------------- |
| `trocco_get_datamart_definitions`       | データマート定義一覧を取得   | `limit`, `name`                 |
...
| ツール名                                | 説明                           | パラメータ                      |
| --------------------------------------- | ------------------------------ | ------------------------------- |
| `trocco_get_pipeline_definitions`       | ワークフロー一覧を取得         | `limit`                         |
